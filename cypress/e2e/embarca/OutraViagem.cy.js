describe("Fluxo de uma nova viagem tendo outra em andamento", () => {
  it("Deve realizar a busca com sucesso e reservar a poltrona", () => {
    ...
    //Clica em Histórico
    cy.get("#history-tab > a").click();

    // Clica em nova viagem
    cy.get(".seats > .btn").click();
    ...
    //Valida que o valor Total está sendo exibido
    cy.get("#value-total-price").should("be.visible");
